var objects = {
  createWorldCoordinateFrame: function (segment_length = 4) {
   ...
   * @returns THREE.Group
   */
  createArrow: function (direction, length, color) {
   ...
   * @returns THREE.Group
   */
  createCoordinateFrame: function () {
   ...
   * @returns
   */
  createCoordinatePlanes: function (grid_unit = 0.5, plane_size = 6) {
